...
function userzc()
{
	//document.regForm.submit();  //这是传统的页面刷新的方案
	//改成ajax注册
	//op=reg&uname=aaaaaa&pwd=aaaaaa&pwdagain=aaaaaa&email=a%40163.com&zccode=7816
...
function changeVilidateCode(obj){
	...
	obj.src="image.jsp?d="+timenow;//为了让服务器认为客户端的每次请求验证码都是全新的，所以加入了时间错
}
